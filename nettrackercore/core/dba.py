...
class DBA:
    ...
    def get_networks(self):
        ...
        """
        networks_table = Table(title=translator.translate("Redes"))
        networks = self.dao.get_all_networks()
        networks_table.add_column(translator.translate("ID"), style="cyan")
        networks_table.add_column(translator.translate("Nombre"), style="cyan")
        networks_table.add_column(translator.translate("Dirección de red"), style="cyan")
    ...
    def get_network(self, network_name):
        ...
        :rtype: :py:class:`~rich.table.Table`
        """
        network_table = Table(title=translator.translate("Red {network_name}").format(network_name=network_name))
        network = self.dao.get_network_from_name(network_name)
        network_table.add_column(translator.translate("ID"), style="cyan")
        network_table.add_column(translator.translate("Nombre"), style="cyan")
        network_table.add_column(translator.translate("Dirección de red"), style="cyan")
        network_table.add_column(translator.translate("Puerta de enlace"), style="cyan")
        network_table.add_column(translator.translate("Máscara de subred"), style="cyan")
        network_table.add_column(translator.translate("Dispositivos"), style="cyan")
    ...
    def get_devices(self, network_name):
        ...
        devices_table = Table(title=translator.translate("Disposistivos de {network_name}").format(network_name=network_name))
        devices_table.add_column(translator.translate("ID"), style="cyan")
        devices_table.add_column(translator.translate("Nombre"), style="cyan")
        devices_table.add_column(translator.translate("Dirección IP"), style="cyan")
        devices_table.add_column(translator.translate("Sistema operativo"), style="cyan")
        devices_table.add_column(translator.translate("Servicios activos"), style="cyan")
    ...
    def get_services(self, network_name, device_address):
        ...
        services_table = Table(
            title=translator.translate("Servicios activos del dispositivo {device_address} dentro de {network_name}").format(
                device_address=device_address, network_name=network_name))
        services_table.add_column(translator.translate("Nombre"), style="cyan")
        services_table.add_column(translator.translate("Puerto"), style="cyan")
        services_table.add_column(translator.translate("Protocolo"), style="cyan")
