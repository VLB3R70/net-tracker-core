...
"""
    ...
    def __create_network(self, dao, address, netmask):
        ...
        while True:
            ...
            try:
                ...
                update = Prompt.ask(self.translator._("¿Quieres actualizar la red actual con dicho nombre?[S/n]"))
    ...
    def save_scan(self, scan_result: JSONResult, options):
        ...
        if "/" in options["TARGET"]:
            ...
            console.print(self.translator._("El dispositivo o dispositivos deben pertenecer a una red."))
